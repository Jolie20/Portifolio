  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-4xl text-center">
        ...
        >
          <span className="text-6xl mb-6 text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400"></span>
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12 text-center md:text-left">
            ...
            <div className="flex-1">
              ...
              >
                I design intuitive digital products, craft strong visual and
                motion designs, and develop smart systems using embedded
                technologies. My work focuses on solving real-world problems by
                combining thoughtful design with practical, technology-driven
                solutions.
              </motion.p>
